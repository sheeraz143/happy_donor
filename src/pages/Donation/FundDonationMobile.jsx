...
export default function FundDonationMobile() {
  ...
  useEffect(() => {
    ...
    if (tokenFromUrl) {
      ...
      // Update the URL to replace the original token with the encoded one
  ...
  return (
    ...
    >
      ...
      <div className="d-flex align-items-center justify-content-around">
        ...
        <div>
          {/* Modal for existing token */}
          {showPopup && (
            <div className="modal-overlay">
              <div className="modal">
                <p>You already have a token stored!</p>
                <button
                  onClick={() => {
                    setShowPopup(false);
